...
If you're migrating from our previous releases, please review their changes in addition to this section.
...
If you're migrating from our previous alpha release, please review the changes listed below.
...
For a complete list of changes, [see the v5.0.0-alpha2 project on GitHub](https://github.com/orgs/twbs/projects/13).
...
- <span class="badge text-warning-emphasis bg-warning-subtle">Deprecated</span> `.text-muted` will be replaced by `.text-body-secondary` in v6.
  ...
  With the addition of the expanded theme colors and variables, the `.text-muted` variables and utility have been deprecated with v5.0.0. Its default value has also been reassigned to the new `--bs-secondary-color` CSS variable to better support color modes. It will be removed in v6.0.0.
...
For a complete list of changes, [see the v5.0.0 project on GitHub](https://github.com/twbs/bootstrap/projects/).
